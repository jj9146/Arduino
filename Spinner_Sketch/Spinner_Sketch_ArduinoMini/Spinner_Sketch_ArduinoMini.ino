...
int ModeButton = 7; // The Mode-switching Button
...
void loop() 
{
    ...
    if(digitalRead(ModeButton) == LOW) 
    {
        ...
        usbDetectorLib.println("Button Pressed!");
        if(_mode == 0)
        {
    ...
    if(_mode == 1)
    {
        ...
        // Report the state to the Serial Monitor
        //usbDetectorLib.print("Hall State: ");
        //usbDetectorLib.println(HallState);
        ...
        if(HallState == LOW)
        {
            ...
            if(_isLow == false)
            {
                ...
                // Report the rotation time
                usbDetectorLib.print("Rotation Time (in milliseconds): " );
                usbDetectorLib.println(RotationTime);
